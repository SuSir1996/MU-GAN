...
def parse(args=None):
    ...
    parser.add_argument('--lambda_1', dest='lambda_1', type=float, default=200.0)           # gr_loss
    parser.add_argument('--lambda_2', dest='lambda_2', type=float, default=100.0)           # gc_loss
    parser.add_argument('--lambda_3', dest='lambda_3', type=float, default=3.0)             # dc_loss
    parser.add_argument('--lambda_gp', dest='lambda_gp', type=float, default=10.0)          # df_loss
    
    parser.add_argument('--mode', dest='mode', default='wgan', choices=['wgan', 'lsgan', 'dcgan'])
    parser.add_argument('--epochs', dest='epochs', type=int, default=100, help='# of epochs')   # epoch
    parser.add_argument('--batch_size', dest='batch_size', type=int, default=8)
    parser.add_argument('--num_workers', dest='num_workers', type=int, default=4)           # 多线程
    parser.add_argument('--lr', dest='lr', type=float, default=0.0001, help='learning rate')# 学习率
    parser.add_argument('--beta1', dest='beta1', type=float, default=0.5)
    parser.add_argument('--beta2', dest='beta2', type=float, default=0.999)
    parser.add_argument('--n_d', dest='n_d', type=int, default=10, help='# of d updates per g update')
    ...
    parser.add_argument('--save_interval', dest='save_interval', type=int, default=8000)
    parser.add_argument('--sample_interval', dest='sample_interval', type=int, default=8000)
